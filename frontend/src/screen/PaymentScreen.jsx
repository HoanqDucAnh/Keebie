  ...
  return (
    ...
    <div className='flex font-mono p-5 gap-x-[80px] justify-center bg-white'>
      ...
      <div>
        ...
        <Radio.Group onChange={onChangeShipping} value={shipping} className='w-[350px] border-2 p-2 rounded-lg'>
          <Space direction="vertical">
            <Collapse
              ...
              items={[
              {
                ...
                children: <p className='w-[330px]'>Địa chỉ nhận hàng trực tiếp: 144 Xuân Thủy, Dịch Vọng Hậu, Cầu Giấy, Hà Nội</p>,
                showArrow: false,
              },
              {
                key: '2',
                label: <Radio value={2}>Vận chuyển thường</Radio>,
                children: <p className='w-[330px]'>Thời gian dự kiến: 2 ngày (Hà Nội) và 3-4 ngày (các tỉnh khác)</p>,
                showArrow: false,
              },
              {
                key: '3',
                label: <Radio value={3}>Vận chuyển nhanh</Radio>,
                children: <p className='w-[330px]'>Thời gian dự kiến: 1 ngày (Hà Nội) và 2-3 ngày (các tỉnh khác)</p>,
                showArrow: false,
              } 
              ]} />
          </Space>
        ...
        <Radio.Group onChange={onChangePayment} value={payment} className='w-[350px] border-2 p-2 rounded-lg'>
          <Space direction="vertical">
            <Collapse
              defaultActiveKey={['1']}
              accordion
              ...
              items={[
                ...
                },
                {
                  ...
                  children: <div className='w-[330px]'>
                    <p className='mb-2 ml-2'>Quý khách chuyển tiền vào tài khoản dưới đây và đính kèm link ảnh chụp màn hình chuyển khoản.</p>
                    <img src="https://scontent.fhan14-4.fna.fbcdn.net/v/t1.15752-9/407243540_1735952993579268_2477408516973975277_n.png?_nc_cat=109&ccb=1-7&_nc_sid=8cd0a2&_nc_ohc=VC-klUyOIZAAX8mvgMc&_nc_ht=scontent.fhan14-4.fna&oh=03_AdRFg1HHUC0XodzAXmgs3EgIqAfVdtwmEZU-dPY4CC0WSw&oe=65B5C578" alt="Vietcombank" className='w-[300px] ml-2' />
